...
class JCalibrateHCalProcessor : public JEventProcessorSequentialRoot {
  ...
  private:
    ...
    TH2D *hHCalClustEneVsNumHit           = nullptr;
    ...
    TH2D *hHCalTruClustEneVsNumHit        = nullptr;
    ...
    TH2D *hEvtHCalLeadClustEneVsNumHit    = nullptr;
    ...
    TH2D *hEvtHCalLeadTruClustEneVsNumHit = nullptr;
