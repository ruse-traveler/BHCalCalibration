// ----------------------------------------------------------------------------
// 'JCalibrateHCalWithSciGlassProcessor.cc'
// Derek Anderson
// 03.02.2023
//
...
// user includes
#include "JCalibrateHCalWithSciGlassProcessor.h"
...
extern "C" {
  ...
  InitJANAPlugin(app);
  app -> Add(new JCalibrateHCalWithSciGlassProcessor);
  }
}
...
//-------------------------------------------
void JCalibrateHCalWithSciGlassProcessor::InitWithGlobalRootLock(){

  // create directory in output file
  auto rootfile_svc = GetApplication() -> GetService<RootFile_service>();
  auto rootfile     = rootfile_svc     -> GetHistFile();
  rootfile -> mkdir("JCalibrateHCalWithSciGlass") -> cd();
...
// ProcessSequential
//-------------------------------------------
void JCalibrateHCalWithSciGlassProcessor::ProcessSequential(const std::shared_ptr<const JEvent>& event) {
...
//-------------------------------------------
void JCalibrateHCalWithSciGlassProcessor::FinishWithGlobalRootLock() {
