...
void JCalibrateHCalProcessor::InitWithGlobalRootLock(){
  ...
  hHCalClustEneVsNumHit           = new TH2D("hHCalClustEneVsNumHit", "Barrel HCal", nNumBin,   rNumBin[0],   rNumBin[1],   nEneBin,   rEneBin[0],   rEneBin[1]);
  // bhcal cluster hit histograms
  ...
  hHCalTruClustEneVsNumHit        = new TH2D("hHCalTruClustEneVsNumHit", "Barrel HCal", nNumBin,   rNumBin[0],   rNumBin[1],   nEneBin,   rEneBin[0],   rEneBin[1]);
  ...
  hEvtHCalLeadClustEneVsNumHit    = new TH2D("hEvtHCalLeadClustEneVsNumHit", "Barrel HCal", nNumBin,  rNumBin[0],  rNumBin[1], nEneBin, rEneBin[0], rEneBin[1]);
  ...
  hEvtHCalLeadTruClustEneVsNumHit = new TH2D("hEvtHCalLeadTruClustEneVsNumHit", "Barrel HCal", nNumBin,  rNumBin[0],  rNumBin[1],   nEneBin, rEneBin[0], rEneBin[1]);
  ...
  hHCalTruClustEneVsNumHit        -> Sumw2();
  ...
  hEvtHCalLeadClustEneVsNumHit    -> Sumw2();
  ...
  hEvtHCalLeadTruClustEneVsNumHit -> Sumw2();
...
void JCalibrateHCalProcessor::ProcessSequential(const std::shared_ptr<const JEvent>& event) {
  ...
  for (auto bhCalClust : bhcalClusters()) {
    ...
    hHCalClustEneVsNumHit -> Fill(nHitHCalClust, eHCalClust);
  ...
  for (auto truthHCalClust : bhcalTruthClusters()) {
    ...
    hHCalTruClustEneVsNumHit -> Fill(nHitTruHCalClust, eTruHCalClust);
  ...
  hEvtHCalLeadClustEneVsNumHit    -> Fill(nHitLeadHCalClust, eLeadHCalClust);
  ...
  hEvtHCalLeadTruClustEneVsNumHit -> Fill(nHitLeadTruHCalClust, eLeadTruHCalClust);
...
void JCalibrateHCalProcessor::FinishWithGlobalRootLock() {
  ...
  hHCalClustEneVsNumHit           -> GetXaxis() -> SetTitle(sNumHitClust.Data());
  hHCalClustEneVsNumHit           -> GetYaxis() -> SetTitle(sEneClust.Data());
  hHCalClustEneVsNumHit           -> GetZaxis() -> SetTitle(sCount.Data());
  ...
  hHCalTruClustEneVsNumHit        -> GetXaxis() -> SetTitle(sNumHitTruClust.Data());
  hHCalTruClustEneVsNumHit        -> GetYaxis() -> SetTitle(sEneTruClust.Data());
  hHCalTruClustEneVsNumHit        -> GetZaxis() -> SetTitle(sCount.Data());
  ...
  hEvtHCalLeadClustEneVsNumHit    -> GetXaxis() -> SetTitle(sNumHitClust.Data());
  hEvtHCalLeadClustEneVsNumHit    -> GetYaxis() -> SetTitle(sEneClustLead.Data());
  hEvtHCalLeadClustEneVsNumHit    -> GetZaxis() -> SetTitle(sCount.Data());
  ...
  hEvtHCalLeadTruClustNumHit      -> GetXaxis() -> SetTitle(sNumHitTruClust.Data());
  ...
  hEvtHCalLeadTruClustEneVsNumHit -> GetXaxis() -> SetTitle(sNumHitTruClust.Data());
  hEvtHCalLeadTruClustEneVsNumHit -> GetYaxis() -> SetTitle(sEneTruClustLead.Data());
  hEvtHCalLeadTruClustEneVsNumHit -> GetZaxis() -> SetTitle(sCount.Data());
