// ----------------------------------------------------------------------------
// 'JCalibrateHCalWithSciGlassProcessor.h'
// Derek Anderson
// 03.02.2023
//
...
class JCalibrateHCalWithSciGlassProcessor : public JEventProcessorSequentialRoot {
  ...
  private:
    ...
    PrefetchT<edm4eic::Cluster>               bemcClusters       = {this, "EcalBarrelSciGlassClusters"};
  ...
  public:
    ...
    // ctor
    JCalibrateHCalWithSciGlassProcessor() { SetTypeName(NAME_OF_THIS); }
